...
export const AppRoutes: Routes = [
    ...
    data: {
        ...
        description: '日本で処方可能なベンゾジアゼピン薬剤一覧です。諸外国よりかなり多い34種類あります。 - ジアゼパム換算表です。置換の際に必須となるデータです',
        keywords: 'ジアゼパム換算,置換,アルプラゾラム,ソラナックス,デパス,エチゾラム,リーゼ,クロチアゼパム,ジアゼパム,セルシン,ブロマゼパム,レキソタン,ロフラゼプ酸エチル,メイラックス,ロラゼパム,ワイパックス,エスタゾラム,ユーロジン,クアゼパム,ドラール,ゾルピデム,マイスリー,ニトラゼパム,ベンザリン,フルニトラゼパム,サイレース,ロヒプノール,ブロチゾラム,レンドルミン,ロルメタゼパム,エバミール,リボトリール,ランドセン,グランダキシン',
        twittercard: 'summary',
        twittersite: '@benzoinfojapan',
        twitterimage: 'https://benzoinfojapan.org/assets/images/twitcard.png',
        url: 'https://benzoinfojapan.org/basics',
    ...
    data: {
        ...
        keywords: '減薬,断薬,ジアゼパム換算,置換,アルプラゾラム,ソラナックス,デパス,エチゾラム,リーゼ,クロチアゼパム,ジアゼパム,セルシン,ブロマゼパム,レキソタン,ロフラゼプ酸エチル,メイラックス,ロラゼパム,ワイパックス,エスタゾラム,ユーロジン,クアゼパム,ドラール,ゾルピデム,マイスリー,ニトラゼパム,ベンザリン,フルニトラゼパム,サイレース,ロヒプノール,ブロチゾラム,レンドルミン,ロルメタゼパム,エバミール,リボトリール,ランドセン,グランダキシン',
        twittercard: 'summary',
        twittersite: '@benzoinfojapan',
